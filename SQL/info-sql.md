  ...
  Info generali:<br>
  Ambito	Linguaggio / DB	IDE / Strumento<br>
  DB	MySQL	      MySQL Workbench<br>
  DB	Oracle	    Oracle SQL Developer<br>
  DB	SQL Server	SQL Server Management Studio (SSMS)<br>
  BE	Java	      Eclipse<br>
  BE	Java	      NetBeans<br>
  BE	Java	      IntelliJ IDEA<br>
  BE	C#	        Visual Studio<br>
  FE	—	          Visual Studio Code<br>
  </p>
